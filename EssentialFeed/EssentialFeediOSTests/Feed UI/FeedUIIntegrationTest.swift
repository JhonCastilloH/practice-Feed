...
class FeedUIIntegrationTest: XCTestCase {
    ...
    func test_loadingFeedIndicator_isVisibleWhileLoadingFeed() {
        ...
        XCTAssertFalse(sut.isShowingLoadingIndicator, "Expected no loading indicator once loading is completes success")
    ...
    func test_feedImageView_isVisibleOnImageURLoadError() {
        let (sut, loader) = makeSUT()
    ...
    func test_feedImageViewRetryButton_isVisisbleOnInvalidImageData() {
        let (sut, loader) = makeSUT()
